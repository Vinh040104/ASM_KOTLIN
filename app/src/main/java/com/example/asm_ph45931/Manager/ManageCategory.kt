package com.example.asm_ph45931.Manager
...
//        contentAlignment = Alignment.Center
        ...
        Column(
            ...
            ManageItem("Thêm loại món ăn", R.drawable.logo)
            ManageItem("Sửa loại món ăn", R.drawable.logo)
            ManageItem("Xóa loại món ăn", R.drawable.logo)
